        ...
        assertArrayEquals(
                new Object[] {
                        ...
                        homeworkService.assignHomework(mockHttpSession, "软件工程测试作业", createDate("2017-12-31"), 100,
                                ...
                                1),
                        homeworkService.assignHomework(mockHttpSession, "", createDate("2017-12-31"), 100,
                                "本作业为软件工程测试作业，仅作测试之用", null,
                                1),
                        homeworkService.assignHomework(mockHttpSession, "软件工程测试作业", null, 100,
                                "本作业为软件工程测试作业，仅作测试之用", null,
                                1),
                        ...
                        homeworkService.assignHomework(mockHttpSession, "软件工程测试作业", createDate("2017-12-31"), 100,
                                "\'本作业为软件工程测试作业，仅作测试之用", null,
                                1),
                        homeworkService.assignHomework(mockHttpSession, "软件工程测试作业", createDate("2018-0-0"), 100,
                                "本作业为软件工程测试作业，仅作测试之用", null,
                                1),
                        homeworkService.assignHomework(mockHttpSession, "软件工程测试作业", createDate("2017-12-31"), 100,
